...
1. Using the Chrome or FireFox to visit URL *http://Instance's Internet IP:9090*
  ![log in phpMyadmin](https://libs.websoft9.com/Websoft9/DocsPicture/en/mysql/mysql-login-websoft9.png)

2. Enter username and password of MySQL([Don't known password?](/stack-accounts.md))

3. Start to manage MySQL now
